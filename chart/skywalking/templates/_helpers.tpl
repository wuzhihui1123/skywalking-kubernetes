...
- name: wait-for-elasticsearch
  ...
  command: ['sh', '-c', 'for i in $(seq 1 60); do nc -z -w3 {{ .Values.oap.env.SW_STORAGE_ES_CLUSTER_NODES_HOST }} {{ .Values.oap.env.SW_STORAGE_ES_CLUSTER_NODES_PORT }} && exit 0 || sleep 5; done; exit 1']
{{- end -}}
